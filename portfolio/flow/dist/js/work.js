...
/***/ "../../src/js/main-scripts/globals.js":
/*!********************************************!*\
  !*** ../../src/js/main-scripts/globals.js ***!
  \********************************************/
...
/* harmony export */   "afterAllPageImagesLoaded": function() { return /* binding */ afterAllPageImagesLoaded; },
/* harmony export */   "scrollbar": function() { return /* binding */ scrollbar; },
/* harmony export */   "scrollerInit": function() { return /* binding */ scrollerInit; },
/* harmony export */   "globalScrollingAnimations": function() { return /* binding */ globalScrollingAnimations; },
/* harmony export */   "scrollAfterLoadPage": function() { return /* binding */ scrollAfterLoadPage; },
/* harmony export */   "updateEffectsController": function() { return /* binding */ updateEffectsController; },
/* harmony export */   "updateEffectsControllerID": function() { return /* binding */ updateEffectsControllerID; },
/* harmony export */   "addEffectToController": function() { return /* binding */ addEffectToController; },
/* harmony export */   "worksEffectsInit": function() { return /* binding */ worksEffectsInit; }
/* harmony export */ });
...
function afterAllPageImagesLoaded() {
  if (!Modernizr.device_xs) {// afterAllImagesLoadedEffectsInit();
  }
}
let scroller;
let scrollbar;
function scrollerInit() {
  ...
  if (!Modernizr.device_xs && scroller) {
    smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__.default.destroy(document.getElementById('horiz-scrollbar'));
    ...
    scrollbar = smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__.default.init(scroller, {
      damping: 0.07
    });
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.scrollerProxy(scroller, {
      scrollTop(value) {
        if (arguments.length) {
    ...
    scrollbar.addListener(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.update);
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.defaults({
      scroller: scroller
    });
  }
}
function globalScrollingAnimations() {
  //global animations
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax]").each(function (index, el) {
    ...
    thisUpdate();
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
        start: "top bottom",
        end: () => "+=" + effectLength,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax-x]").each(function (index, el) {
    const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax-percent]").each(function (index, el) {
    const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax-parallax]").each(function (index, el) {
    const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    let from = 0;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax-parallax-top]").each(function (index, el) {
    const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    let from = 0;
    let scaleFrom = 1;
    let scaleTo = 1;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-skarallax-scale]").each(function (index, el) {
    const $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("*[data-fixed-end]").each(function (index, el) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnime").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnime2").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeLeft").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeLeft2").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeTop").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeFade").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeFade2").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeRight").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTitleAnimeScale").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsAnimeWidth").each(function (index, el) {
    let $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    const thisTimeLine = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: {
        trigger: $element,
        start: "top bottom",
        toggleActions: "play none none reverse"
...
function scrollAfterLoadPage(anchor) {
  console.log(anchor);

  if (!Modernizr.device_xs && jquery__WEBPACK_IMPORTED_MODULE_0___default()("#scrolled").length) {
    var target = jquery__WEBPACK_IMPORTED_MODULE_0___default()(anchor);
    console.log(target);
...
function updateEffectsControllerID(itemID) {
  for (let item of effectsController.items) {
    if (item.id === itemID) {
      if (item.updateFunc) {
        item.updateFunc();
...
function addEffectToController(itemToAdd) {
...
function worksEffectsInit() {
  console.log("workseffectsInit");
  console.log(worksEffectsArray.items);

  for (let item of worksEffectsArray.items) {
    let thisTL;
    thisTL = gsap__WEBPACK_IMPORTED_MODULE_3__.default.timeline({
      scrollTrigger: item.st
    });
...
/* harmony import */ var _src_js_vendors_SplitText_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../src/js/vendors/SplitText.min */ "../../src/js/vendors/SplitText.min.js");
/* harmony import */ var _src_js_vendors_SplitText_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_js_vendors_SplitText_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ "../../node_modules/gsap/gsap-core.js");
/* harmony import */ var _src_js_main_scripts_globals__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../src/js/main-scripts/globals */ "../../src/js/main-scripts/globals.js");
...
function workAnimations() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".work-first-section").each(function () {
    ...
    var thisUpdate = function updateValues() {
      scrollAmount1 = window.innerHeight * 4;
      scrollAmount2 = scrollAmount1 + window.innerHeight;
      scrollAmount3 = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect2").outerHeight();
    };

    thisUpdate();
    window.worksEffectsArray.items.push({
      id: "bethouseWork" + itemId,
      st: {
        trigger: '.sect1',
        start: 0,
        end: function end() {
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.secthold'), 1, {
        ...
        }, 0], ["fromTo", $element.find('.center-box'), 0.15, {
          opacity: 1
        }, {
          ...
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0.05], ["fromTo", $element.find('.sectbg'), 0.2, {
          opacity: 0
        }, {
          opacity: function opacity() {
            return 1;
          ...
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0.1], ["fromTo", $element.find('.part1'), 0.1, {
          autoAlpha: 0
        }, {
          autoAlpha: function autoAlpha() {
            return 1;
          },
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0.2], ["fromTo", $element.find('.part1 .container'), 0.1, {
          y: 0,
          autoAlpha: 1
        }, {
          y: -100,
        ...
        }, 0.4], ["fromTo", $element.find('.part2'), 0.1, {
          autoAlpha: 0,
          y: 100
        }, {
          y: 0,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect2").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmountStart;
    var scrollAmount2;
    var scrollAmount3;

    var thisUpdate = function updateValues() {
      scrollAmountStart = $element.offset().top + 100;
      console.log(scrollAmountStart);
      scrollAmount1 = window.innerHeight;
      scrollAmount2 = window.innerHeight * 30 / 100 + 100;
      scrollAmount3 = window.innerHeight + 300 + jquery__WEBPACK_IMPORTED_MODULE_0___default()(".motion-textbox").outerHeight();
    };
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.bottom-row'), 1, {
          y: 0
        }, {
          y: function y() {
            return scrollAmount1;
          ...
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0], ["fromTo", $element.find('.bottom-row'), 0.5, {
          opacity: 1
        }, {
          opacity: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
    ...
    window.worksEffectsArray.items.push({
      ...
      st: {
        ...
        start: "top 30%",
          ...
          return "+=" + scrollAmount2;
        },
        scrub: true
      },
      realTL: {
        tlBody: [["fromTo", $element.find('.bottom-row-wrap'), 1, {
          y: 0
        }, {
          y: function y() {
            return 150;
    ...
    window.worksEffectsArray.items.push({
      id: "bethouseWork" + itemId,
      st: {
        trigger: '.motion-textbox',
        start: "top bottom",
        end: function end() {
          return "+=" + scrollAmount3;
        },
        scrub: true
      },
      realTL: {
        tlBody: [["fromTo", $element.find('.motion-textbox'), 1, {
          y: -200
        }, {
          y: function y() {
            return 100;
          ...
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0], ["fromTo", $element.find('.motion-textbox'), 0.4, {
          opacity: 0
        }, {
          opacity: function opacity() {
            return 1;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsLoadVideoFull").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var fullVideoWrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect-video-full");
    fullVideoWrap.appendTo("body");
    var $elementVideoFull = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $playVideoCursorBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsCursorFullVideo");
    var $closeVideoBtn = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect-video-full .close-video-btn");
    var videoShort = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".short-videobox .jsLoadVideoBox video")[0];
    var fullVideoProgressTL = gsap__WEBPACK_IMPORTED_MODULE_4__.default.timeline({
      paused: true
    });
    var isVideoPaused = false;
    fullVideoProgressTL.fromTo('.sect-video-full .progress-fill', {
      width: 0
    }, {
      width: "100%"
    }, 0); //анимация по клику на видео курсор

    var fullVideoShowerTL = gsap__WEBPACK_IMPORTED_MODULE_4__.default.timeline({
      paused: true,
      onComplete: completeOpen,
      onReverseComplete: completeClose
    });
    fullVideoShowerTL.fromTo('.sect-video-full', {
      autoAlpha: 0
    }, {
      autoAlpha: 1,
      duration: 1
    }, 0);
    fullVideoShowerTL.fromTo('.global-work-wrapper', {
      autoAlpha: 1
    }, {
      autoAlpha: 0,
      duration: 2
    }, 0);
    (0,_src_js_main_scripts_globals__WEBPACK_IMPORTED_MODULE_2__.addEffectToController)({
      timeLine: fullVideoShowerTL,
      updateFunc: null,
      id: "effectVideoFull"
    }); //заранее создаем видео элемент (без подгрузки видео)

    var isVideoFullLoaded = false;
    var videoElement = $elementVideoFull[0];
    var videoFull = document.createElement('video');
    ...
    videoFull.playsInline = true; //play video click

    $playVideoCursorBtn.on("click", function () {
      console.log("clicked");

      if (!isVideoFullLoaded) {
        var alertFunc = function alertFunc() {
          videoFull.pause();
          console.log(videoFull.readyState);

          if (videoFull.readyState >= readyState) {
            clearInterval(CheckVideoDownLoadTimer);
            isVideoFullLoaded = true;
            videoFull.play();
            fullVideoShowerTL.play();
            fullVideoProgressTL.duration(videoFull.duration);
            fullVideoProgressTL.play();
          }
        };

        videoFull.append(sourceMP4);
        videoElement.append(videoFull);
        var CheckVideoDownLoadTimer = setInterval(alertFunc, 300);
      } else {
        fullVideoShowerTL.play();
        videoFull.play();
        fullVideoProgressTL.restart();
      }
    }); //close video click!!
    ...
    $closeVideoBtn.on("click", function () {
      videoFull.pause();
      isVideoPaused = false;
      fullVideoShowerTL.reverse(0.5);
      fullVideoProgressTL.pause();
    }); //pause play

    $elementVideoFull.on("click", function () {
    ...
    function completeOpen() {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".videoCloseWrap").fadeIn("fast");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect7").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmountStart;
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.main-title'), 1, {
          y: -200
        }, {
          y: function y() {
            return 100;
          ...
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
        }, 0], ["fromTo", $element.find('.main-title'), 0.4, {
          opacity: 0
        }, {
          opacity: function opacity() {
            return 1;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsTwoCircles").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmount2;
    ...
    var thisUpdate = function updateValues() {
      ...
      scrollAmount2 = window.innerHeight / 2;
    };
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.circle:first-child'), {
          scale: 0.5,
          opacity: 0
        }, {
          scale: 1,
          opacity: 1,
          duration: 0.5
        }, 0], ["fromTo", $element.find('.circle:first-child span'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.25,
          duration: 1
        }, 0], ["fromTo", $element.find('.circle:last-child'), {
          scale: 0.5,
          opacity: 0
        }, {
          scale: 1,
          ...
          opacity: 1,
          duration: 0.5
        }, 0], ["fromTo", $element.find('.circle:last-child span'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.5,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsScaleTest").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmount2;
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".jsThreeCircles").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmount2;
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.circle1'), {
          scale: 0.5,
          opacity: 0
        }, {
          scale: 1,
          opacity: 1,
          duration: 0.5
        }, 0], ["fromTo", $element.find('.circle1 span'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.25,
          duration: 1
        }, 0], ["fromTo", $element.find('.circle2'), {
          x: -100,
          opacity: 0
        }, {
          x: 0,
          ...
          opacity: 1,
          duration: 0.8
        }, 0], ["fromTo", $element.find('.circle2 span'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.6,
          duration: 1
        }, 0], ["fromTo", $element.find('.circle3'), {
          y: -100,
          opacity: 0
        }, {
          y: 0,
          ...
          opacity: 1,
          duration: 0.8
        }, 0], ["fromTo", $element.find('.circle3 span'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.8,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".lined-centered-box").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var scrollAmount1;
    var scrollAmount2;
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.line'), {
          height: 0
        }, {
          height: "100%",
          duration: 1
        }, 0], ["fromTo", $element.find('.text-wrap'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.25,
          duration: 1
        }, 0], ["fromTo", $element.find('.textbg'), {
          opacity: 0
        }, {
          opacity: 1,
          delay: 0.3,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".house-sect").each(function () {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $trigger = $element;
    var $trigger2 = $element.find(".ipad-inside");
    var $ipadBG = $element.find(".ipad-bg");
    var $ipad = $element.find(".house-ipad");
    var scrollAmount1, scrollAmount2;
    var scrollAmount3;

    var thisUpdate = function updateValues() {
      scrollAmount1 = $element.offset().top;
      scrollAmount2 = $element.outerHeight() + window.innerHeight;
      scrollAmount3 = $trigger2.outerHeight() + window.innerHeight;
    };
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["fromTo", $element.find('.sectbg img'), 1, {
          scale: 1.3
        }, {
          scale: 1,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__.Linear.easeNone
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".no-device_xs .jsAnimeTextLines").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var endEffect;
    ...
    window.worksEffectsArray.items.push({
      ...
      realTL: {
        tlBody: [["staggerFrom", $element.find("em"), 0.7, {
          y: "150%"
        }, 0.2, 0]]
      },
      updateFunc: thisUpdate
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".no-device_xs .sect4 .top-text-wrapper").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    window.worksEffectsArray.items.push({
      id: "erialWork" + itemId,
      st: {
      ...
      realTL: {
        tlBody: [["fromTo", $element.find(".line-wrapper"), 2.5, {
          width: 0
        }, {
          width: "100%"
        }, 0], ["staggerFrom", $element.find(".rightcol p span"), 1, {
          y: 260
        }, 0.1, 1], ["fromTo", jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect4 .top-subtext-box p"), 1, {
          y: -100
        }, {
          y: 0
        }, 1]]
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect13 .cards-row .leftcol .card").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    window.worksEffectsArray.items.push({
      id: "erialWork" + itemId,
      st: {
      ...
      realTL: {
        tlBody: [["fromTo", $element.find("span"), 1, {
          y: 50,
          opacity: 0
        }, {
          y: 0,
          opacity: 1
        }, 0], ["fromTo", $element.find("img"), 1, {
          opacity: 0
        }, {
          opacity: 1
        }, 0.5]]
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".sect13 .cards-row .rightcol .card").each(function (index, el) {
    var $element = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    window.worksEffectsArray.items.push({
      id: "erialWork" + itemId,
      st: {
...
function workAnimationsStatic() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_4__.default.fromTo('.work-first-section .sect-content', {
    y: "70vh"
  }, {
    y: 0,
    duration: 2,
